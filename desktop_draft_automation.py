...
def build_html(case: dict[str, Any], banner_path: Path | None = None) -> tuple[str, dict[str, str]]:
    ...
    # Outlook's Word renderer can ignore white-space:nowrap on spans and break
    # long model/serial strings at hyphens. <nobr> plus nowrap on the cell keeps
    # each asset together; the explicit <br> still separates multiple assets.
    assets = "<br>".join(
        f'<nobr style="white-space:nowrap;word-break:keep-all">{esc(asset)}</nobr>'
...
<table class="MsoNormalTable" border="0" cellspacing="0" cellpadding="0" width="780" style="width:585pt;border-collapse:collapse;table-layout:fixed;mso-table-lspace:0pt;mso-table-rspace:0pt">
<tr><td width="200" valign="middle" style="border:1px solid #000;padding:4pt 8pt;vertical-align:middle;font-family:Calibri,Arial,sans-serif;font-size:11pt;word-wrap:break-word;overflow-wrap:break-word;width:150pt"><p class="MsoNormal" align="center" style="margin:0;font-family:Calibri,Arial,sans-serif;font-size:11pt;line-height:13pt;mso-line-height-rule:exactly;text-align:center"><b>Pickup Address</b></p></td><td width="580" valign="middle" style="border:1px solid #000;padding:4pt 8pt;vertical-align:middle;font-family:Calibri,Arial,sans-serif;font-size:11pt;word-wrap:break-word;overflow-wrap:break-word;width:435pt"><p class="MsoNormal" align="center" style="margin:0;font-family:Calibri,Arial,sans-serif;font-size:11pt;line-height:13pt;mso-line-height-rule:exactly;text-align:center">{address}</p></td></tr>
<tr><td width="200" valign="middle" style="border:1px solid #000;padding:4pt 8pt;vertical-align:middle;font-family:Calibri,Arial,sans-serif;font-size:11pt;word-wrap:break-word;overflow-wrap:break-word;width:150pt"><p class="MsoNormal" align="center" style="margin:0;font-family:Calibri,Arial,sans-serif;font-size:11pt;line-height:13pt;mso-line-height-rule:exactly;text-align:center"><b>Asset Type &amp;<br>Serial Number</b></p></td><td width="580" nowrap="nowrap" valign="middle" style="border:1px solid #000;padding:4pt 8pt;vertical-align:middle;font-family:Calibri,Arial,sans-serif;font-size:11pt;word-wrap:normal;overflow-wrap:normal;white-space:nowrap;width:435pt"><p class="MsoNormal" align="center" style="margin:0;font-family:Calibri,Arial,sans-serif;font-size:11pt;line-height:13pt;mso-line-height-rule:exactly;text-align:center;white-space:nowrap">{assets}</p></td></tr>
</table>
